    ...
    <footer className="bg-[#B8A5D4] text-[#2D1B5A]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-8">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-lg font-bold text-[#2D1B5A] mb-4">Quick Links</h3>
          ...
          {/* Contact & Support */}
          <div>
            <h3 className="text-lg font-bold text-[#2D1B5A] mb-4">Contact & Support</h3>
            <ul className="space-y-3 mb-4">
              <li className="flex items-start space-x-3">
                ...
                <span className="text-[#2D1B5A]/80">+880 1234-567890</span>
              </li>
              <li className="flex items-start space-x-3">
                <svg className="w-5 h-5 text-[#2D1B5A] flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="border-t border-[#2D1B5A]/20 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex space-x-6 text-sm">
              ...
              <Link href="/terms" className="text-[#2D1B5A]/80 hover:text-[#2D5016] transition duration-200">
                Terms of Service
              </Link>
              <Link href="/cookies" className="text-[#2D1B5A]/80 hover:text-[#2D5016] transition duration-200">
                Cookie Policy
              </Link>
            </div>
          </div>
